...
def test_cherche2_debut_milieu_fin():
    ...
    lstop = ['ion', 'me']
    nmin, nmax = 5, 15
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'programmation'}
...
def test_cherche2_tous_listes_vides():
    ...
    lstop = []
    nmin, nmax = 5, 15
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'programmation', 'python', 'codage', 'algorithme'}
...
def test_cherche2_longueur_min():
    ...
    lstop = ['on']
    nmin, nmax= 6, 10
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'python'}
...
def test_cherche2_longueur_max():
    ...
    lstop = ['ion']
    nmin, nmax = 5, 12
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == set()
...
def test_cherche2_juste_un_mot():
    ...
    lstop = ['me']
    nmin, nmax = 5, 20
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'algorithme'}
...
def test_cherche2_mots_de_taille_minimale():
    ...
    lstop = []
    nmin, nmax = 2, 2
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'pr', 'py'}
...
def test_cherche2_commence_par_et_se_termine_par():
    ...
    lstop = ['tion']
    nmin, nmax = 5, 15
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'promotion'}
...
def test_cherche2_juste_milieu():
    ...
    lstop = []
    nmin, nmax = 5, 20
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'parallèle', 'programmation'}
...
def test_cherche2_liste_mot_unique_pas_filtré():
    ...
    lstop = []
    nmin, nmax = 5, 10
    assert cherche2(ensemble_mots, lstart, lmid, lstop, nmin, nmax) == {'seulement'}
